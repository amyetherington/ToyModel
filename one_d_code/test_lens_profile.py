...
class TestShear:
    def test__shear_isothermal_sphere_equals_analytic(self):
        power_law = profiles.SphericalPowerLaw(einstein_radius=1.8, slope=2, z_s=0.8, z_l=0.3)
...
class TestEinsteinRadius:
    def test__mean_power_law_convergence_within_einstein_radius_equal_to_one(self):
        power_law = profiles.SphericalPowerLaw(einstein_radius=1.8, slope=2.3, z_s=0.8, z_l=0.3)
    ...
    def test__mean_power_law_convergence_within_calculated_einstein_radius_equal_to_one(self):
        power_law = profiles.SphericalPowerLaw(einstein_radius=1.6, slope=2.3, z_s=0.8, z_l=0.3)
...
class TestCriticalSurfaceDensity:
    def test_equal_to_autolens_function_in_desired_units(self):
        ...
        autolens_sigma_crit = cosmology_util.critical_surface_density_between_redshifts_from_redshifts_and_cosmology(
            redshift_1=0.8, redshift_0=0.3, unit_length="kpc", unit_mass="solMass"
        )
