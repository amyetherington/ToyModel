...
DM_Hilb = profile.NFW_Hilbert(m200=1.1e13, z_l=0.351, z_s=1.071)
...
coeffs = total.best_fit_power_law_convergence_coefficients_from_mask_and_radii(mask=no_mask, radii=radii)
