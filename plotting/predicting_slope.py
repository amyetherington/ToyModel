...
mask = true_profile.mask_radial_range_from_radii(radii=radii, lower_bound=0.8, upper_bound=1.2)
mask_inner_image = true_profile.mask_two_radial_ranges_from_radii(
    radii=radii, lower_bound_1=0.2, upper_bound_1=0.3, lower_bound_2=0.8, upper_bound_2=1.2)
...
plt.loglog(radii, kappa_best_fit_from_alpha_inner_image, label='best fit alpha with image')
