...
print(Hernquist.two_dimensional_mass_enclosed_within_radii(radii=radii))
print(Hernquist.three_dimensional_mass_enclosed_within_radii(radii=radii))

print(total.r_eff)
print(total.two_dimensional_mass_enclosed_within_radii(radii=radii))
print(total.three_dimensional_mass_enclosed_within_radii(radii=radii))
...
k_Bartelmann = 0.5 * (
    (alpha_Bartelmann / radii) + np.gradient(alpha_Bartelmann, radii[:])
)
